...
(function (d) {
	var q,
		...
		u = {
			...
			bootstrap: {
				container: "alert",
				notice: "vd_white vd_bg-black-80",
	...
	d.extend({
		...
		pnotify: function (e) {
			var g, a;
			typeof e != "object"
				? ((a = d.extend({}, d.pnotify.defaults)), (a.text = e))
				: (a = d.extend({}, d.pnotify.defaults, e));
			for (var p in a)
				typeof p == "string" &&
					p.match(/^pnotify_/) &&
					(a[p.replace(/^pnotify_/, "")] = a[p]);
			...
			var k,
				o = function (a, c) {
					...
					if (!k || k.get(0) != f)
						k &&
							(n.call(k.get(0), "mouseleave", a.originalEvent),
							n.call(k.get(0), "mouseout", a.originalEvent)),
							n.call(f, "mouseenter", a.originalEvent),
							n.call(f, "mouseover", a.originalEvent);
				...
				b = d("<div />", {
					...
					mouseenter: function (l) {
						...
						a.nonblock &&
							b.stop().animate({ opacity: a.nonblock_opacity }, "fast");
						a.hide && a.mouse_reset && b.pnotify_cancel_remove();
						a.sticker &&
							!a.nonblock &&
							b.sticker.trigger("pnotify_icon").css("visibility", "visible");
					...
					mouseleave: function (l) {
						...
						a.nonblock &&
							g != "out" &&
							b.stop().animate({ opacity: a.opacity }, "fast");
					...
					mousedown: function (b) {
						a.nonblock &&
							(b.stopPropagation(), b.preventDefault(), o(b, "onmousedown"));
					},
					mouseup: function (b) {
						a.nonblock &&
							(b.stopPropagation(), b.preventDefault(), o(b, "onmouseup"));
					},
					click: function (b) {
			...
			a.cornerclass != "" &&
				b.container.removeClass("ui-corner-all").addClass(a.cornerclass);
			...
			b.pnotify = function (l) {
				...
				for (var e in a)
					typeof e == "string" &&
						e.match(/^pnotify_/) &&
						(a[e.replace(/^pnotify_/, "")] = a[e]);
				b.opts = a;
				a.cornerclass != c.cornerclass &&
					b.container.removeClass("ui-corner-all").addClass(a.cornerclass);
				a.shadow != c.shadow &&
					(a.shadow
						? b.container.addClass("ui-pnotify-shadow")
						: b.container.removeClass("ui-pnotify-shadow"));
				a.addclass === false
					? b.removeClass(c.addclass)
					: a.addclass !== c.addclass &&
					  b.removeClass(c.addclass).addClass(a.addclass);
				a.title === false
					? b.title_container.slideUp("fast")
					: a.title !== c.title &&
					  (a.title_escape
							? b.title_container.text(a.title).slideDown(200)
							: b.title_container.html(a.title).slideDown(200));
				a.text === false
					? b.text_container.slideUp("fast")
					: a.text !== c.text &&
					  (a.text_escape
							? b.text_container.text(a.text).slideDown(200)
							: b.text_container
									.html(
										a.insert_brs
				...
				a.min_height !== c.min_height &&
					b.container.animate({ minHeight: a.min_height });
				a.opacity !== c.opacity && b.fadeTo(a.animate_speed, a.opacity);
				!a.closer || a.nonblock
					? b.closer.css("display", "none")
					: b.closer.css("display", "block");
				!a.sticker || a.nonblock
					? b.sticker.css("display", "none")
					: b.sticker.css("display", "block");
				b.sticker.trigger("pnotify_icon");
				a.sticker_hover
					? b.sticker.css("visibility", "hidden")
					: a.nonblock || b.sticker.css("visibility", "visible");
				a.closer_hover
			...
			b.pnotify_position = function (a) {
				...
				if (c) {
					...
					if (!d || a) {
						...
						if (
							(c.dir1 == "down" && c.nextpos1 + b.height() > i.height()) ||
							(c.dir1 == "up" && c.nextpos1 + b.height() > i.height()) ||
							(c.dir1 == "left" && c.nextpos1 + b.width() > i.width()) ||
							(c.dir1 == "right" && c.nextpos1 + b.width() > i.width())
						)
							(c.nextpos1 = c.firstpos1),
								(c.nextpos2 +=
									c.addpos2 +
									(typeof c.spacing2 == "undefined" ? 25 : c.spacing2)),
								(c.addpos2 = 0);
						...
						else c.nextpos2 && b.css(h, c.nextpos2 + "px");
						switch (c.dir2) {
							case "down":
							case "up":
						...
						if (c.nextpos1)
							if (
								c.animation &&
								(a > c.nextpos1 || e.top || e.bottom || e.right || e.left)
							)
								switch (c.dir1) {
									case "down":
										e.top = c.nextpos1 + "px";
						...
						switch (c.dir1) {
							...
							case "up":
								c.nextpos1 +=
									b.height() +
									(typeof c.spacing1 == "undefined" ? 25 : c.spacing1);
								break;
							case "left":
							case "right":
								c.nextpos1 +=
			...
			b.pnotify_display = function () {
				(h = i.data("pnotify")) &&
					h.length > a.maxonscreen &&
					d.each(h.slice(0, h.length - a.maxonscreen), function () {
						this.pnotify_remove && this.pnotify_remove();
					});
				b.parent().length || b.appendTo(r);
				(a.before_open && a.before_open(b) === false) ||
					(a.stack.push != "top" && b.pnotify_position(true),
					a.animation == "fade" || a.animation.effect_in == "fade"
						? b.show().fadeTo(0, 0).hide()
						: a.opacity != 1 && b.show().fadeTo(0, a.opacity).hide(),
			...
			b.pnotify_remove = function () {
				...
				(a.before_close && a.before_close(b) === false) ||
					b.animate_out(function () {
						(a.after_close && a.after_close(b) === false) ||
							(b.pnotify_queue_position(), a.remove && b.detach());
					});
			};
			b.animate_in = function (d) {
				...
				var c;
				c =
					typeof a.animation.effect_in != "undefined"
						? a.animation.effect_in
						: a.animation;
				c == "none"
					? (b.show(), d())
					: c == "show"
					? b.show(a.animate_speed, d)
					: c == "fade"
					? b.show().fadeTo(a.animate_speed, a.opacity, d)
					: c == "slide"
					? b.slideDown(a.animate_speed, d)
					: typeof c == "function"
					? c("in", d, b)
					: b.show(
							c,
							typeof a.animation.options_in == "object"
								? a.animation.options_in
								: {},
							a.animate_speed,
							d
					  );
			...
			b.animate_out = function (d) {
				...
				var c;
				c =
					typeof a.animation.effect_out != "undefined"
						? a.animation.effect_out
						: a.animation;
				c == "none"
					? (b.hide(), d())
					: c == "show"
					? b.hide(a.animate_speed, d)
					: c == "fade"
					? b.fadeOut(a.animate_speed, d)
					: c == "slide"
					? b.slideUp(a.animate_speed, d)
					: typeof c == "function"
					? c("out", d, b)
					: b.hide(
							c,
							typeof a.animation.options_out == "object"
								? a.animation.options_out
								: {},
							a.animate_speed,
							d
					  );
			...
			b.closer = d("<div />", {
				...
				.append(d("<span />", { class: f.closer, title: a.labels.close }))
			...
			b.sticker = d("<div />", {
				...
				.bind("pnotify_icon", function () {
					d(this)
						.children()
						.removeClass(f.pin_up + " " + f.pin_down)
						.addClass(a.hide ? f.pin_up : f.pin_down);
				})
				.append(d("<span />", { class: f.pin_up, title: a.labels.stick }))
				.appendTo(b.container);
			...
			a.icon !== false &&
				d("<div />", { class: "ui-pnotify-icon" })
					...
					.prependTo(b.container);
			b.title_container = d("<h4 />", { class: "ui-pnotify-title" }).appendTo(
				b.container
			);
			a.title === false
				? b.title_container.hide()
				: a.title_escape
				? b.title_container.text(a.title)
				: b.title_container.html(a.title);
			b.text_container = d("<div />", { class: "ui-pnotify-text" }).appendTo(
				b.container
			);
			a.text === false
				? b.text_container.hide()
				: a.text_escape
				? b.text_container.text(a.text)
				: b.text_container.html(
						a.insert_brs ? String(a.text).replace(/\n/g, "<br />") : a.text
				  );
			typeof a.width == "string" && b.css("width", a.width);
			typeof a.min_height == "string" &&
				b.container.css("min-height", a.min_height);
			b.pnotify_history = a.history;
			b.pnotify_hide = a.hide;
								...
								click: function () {
									d.each(h, function () {
										this.pnotify_history &&
											(this.is(":visible")
												? this.pnotify_hide && this.pnotify_queue_remove()
												: this.pnotify_display && this.pnotify_display());
									});
									return false;
								},
							})
				...
				? ((e = e.replace(t, "")),
				  e.match(v)
						...
						? ((a = document.createEvent("UIEvents")),
						  a.initUIEvent(e, g.bubbles, g.cancelable, g.view, g.detail))
						: e.match(x) &&
