	...
	$.fn.KallesAgeVerify = function () {
		if ($(this).length && Cookies.get("kalles_age_verify") !== "confirmed") {
			let showPopup = function () {
				$.magnificPopup.open({
					items: { src: "#kalles-section-age_verify .popup_age_wrap" },
					type: "inline",
				...
				$col_nav
					...
					.on("click", function (e) {
						...
						let scrollY = $this.hasClass("btn_pnav_next")
							...
							: currentScrollTop - navCellHeight - 40;
						$el.stop().animate({ scrollTop: scrollY }, timer);
					});
			});
		}
	};
