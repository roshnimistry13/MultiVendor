...
#Message: 
UPDATE product_details SET `variant_code` = NULL, `parent_product_id` = NULL WHERE 1=1  and product_id = '17';
#End*******************************************************************************************************
...
#Operation : UPDATE #Operationend
#Message: 
UPDATE product_details SET `variant_code` = 'CL2H8t', `parent_product_id` = '6' WHERE 1=1  and product_id = '17';
#End*******************************************************************************************************
