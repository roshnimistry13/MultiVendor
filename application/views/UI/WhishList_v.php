                                    ...
                                    <div class="col-lg-2 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                                        <div class="product-inner pr">
                                            <div class="product-image pr oh lazyload">
                                                ...
                                                <a class="d-block" href="<?php echo base_url('product-detail/').$row['short_code']; ?>">
                                                ...
                                                <div class="nt_add_w ts__03 pa ">
                                                    <a href="#" class="cb chp ttip_nt tooltip_right wis_remove" data-pid="<?php echo $row['product_id']; ?>"><span
                                                            class="tt_txt">Remove Wishlist</span><i
                                            ...
                                            <div class="product-info mt__15">
                                                ...
                                                <i class="fa fa-inr cr fs__14"></i><ins><?php echo moneyFormatIndia_ui($row['net_price']);?></ins> &nbsp;
                                                <i class="fa fa-inr fs__14"></i> <del><?php echo moneyFormatIndia_ui($row['mrp_price']);?></del>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
