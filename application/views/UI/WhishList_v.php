<div id="nt_wrapper">
    <div id="nt_content">
        ...
        <div id="kalles-section-wishlist_page"
            class="container container_cat pop_default cat_default mb__20 wishlist_page">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="kalles-section tp_se_cdt">
                        <div class="on_list_view_false prs_wis products nt_products_holder row  row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default wishlist-item-div" id="productList">
                                ...
                                <div class="product-inner pr">
                                    <div class="product-image pr oh lazyload">
                                        ...
                                        <div class="nt_add_w ts__03 pa ">
                                            <a href="#" class="cb chp ttip_nt tooltip_left  wis_remove"
                            ...
                            <div class="col-12 py-5 text-center">
                                <i class="las la-shopping-bag pr mb__10 fs__55"></i>
                                <h5 class="text-center">You have no items in your wishlist. Start adding!</h5>
                            </div>
                            <?php } ?> -->
                        </div>
                        <div class="product-pagination">
                            <div id='wishListpagination'></div>
                        </div>
                    </div>
                </div>
            </div>
