    ...
    <div class="container container_cat pop_default cat_default mb__20">
        <div class="cat_toolbar row fl_center al_center mt__30">
            ...
            <!-- <div class="cat_view col-auto on_list_view_false">
                <div class="dn dev_desktop">
                    ...
                    <a href="#" data-mode="grid" data-dev="dk" data-col="3"
        ...
        <div class="filter_area_js filter_area lazyload">
            <div id="kalles-section-nt_filter" class="kalles-section nt_ajaxFilter section_nt_filter">
                <div class="h3 mg__0 tu bgb cw visible-sm fs__16 pr">Filter
                                                ...
                                                <a href="#"
                                                    ...
                                                    <div class="filter-swatch">
                                                        <span class="swatch__value bg_color_white-cream lazyload"
                                                            data-bg="<?php echo UI_ASSETS ?>images/shop/color-white-cream.jpg"></span>
                                                    </div>
                                                    white cream
                                                </a>
                                            </li>
                                ...
                                <div class="row no-gutters wrap_filter">
                                    ...
                                    <div class="col-12 col-md-12 widget widget_product_categories cat_count_false">
                                        ...
                                        <ul class="product-categories">
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Acessories <span
                                                        class="cat_count">(24)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Bottom <span
                                                        class="cat_count">(13)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Denim <span
                                                        class="cat_count">(6)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Dress <span
                                                        class="cat_count">(7)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Jackets <span
                                                        class="cat_count">(6)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Jewellry <span
                                                        class="cat_count">(9)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Men <span
                                                        class="cat_count">(18)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Shoes <span
                                                        class="cat_count">(7)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">Tops <span
                                                        class="cat_count">(8)</span></a>
                                            </li>
                                            <li class="cat-item current-cat">
                                                <a href="javascript:void(0)">Women <span
                                                        class="cat_count">(39)</span></a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="javascript:void(0)">T-Shirt <span
                                                        class="cat_count">(9)</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <ul class="nt_filter_block nt_filter_color css_ntbar">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        <div class="filter-swatch">
                                                            <span
                                                                class="swatch__value bg_color_pink-clay lazyload"></span>
                                                        </div>
                                                        pink clay
                                                    </a>
                                                </li>
            ...
            <div class="col-lg-9 col-12">
                <div class="kalles-section tp_se_cdt">
                    ...
                    <div class="result_clear mt__30 mb__20 dn">
                        ...
                        <a class="clear_filter dib" href="#">Clear All Filter</a><a href="#"
                            class="clear_filter dib bf_icons" aria-label="Remove tag Size  M">Size M</a><a href="#"
                            class="clear_filter dib bf_icons" aria-label="Remove tag Color  Cyan">Color Cyan</a><a
                            href="#" class="clear_filter dib bf_icons" aria-label="Remove tag Vendor  Kalles">MultiVendor</a>
                    </div>
                    ...
                    <div class="on_list_view_false products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default">
                            ...
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    ...
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-01.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-02.jpg"></div>
                                    </div>
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Analogue Resin Strap</a>
                                    </h3>
                            ...
                            <div class="product-inner pr">
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title position-relative fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">La Bohème Rose Gold</a>
                                    </h3>
                                    ...
                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-27.jpg"
                                            class="nt_swatch_on_bg swatch__list--item position-relative ttip_nt tooltip_top_right"><span
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-03.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-04.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Ridley High Waist</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/products/pr-18.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/products/pr-17.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Cream women pants</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Women Black Pants</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_586"
                                            data-bgset="<?php echo UI_ASSETS ?>images/products/pr-33.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_586"
                                            data-bgset="<?php echo UI_ASSETS ?>images/products/pr-34.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Sweatshirt in Geometric
                                            Print</a>
                                    </h3>
                                    <span class="price dib mb__5">$35.00</span>
                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                        ...
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-34.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                ...
                                                class="swatch__value bg_color_blue lazyload"></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-09.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-10.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Mercury Tee</a>
                                    </h3>
                                    ...
                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-15.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                ...
                                                data-bgset="<?php echo UI_ASSETS ?>images/products/dot-01.jpg"></span></span>
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-14.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                class="tt_txt">Heart Dotted</span><span
                                                class="swatch__value bg_color_heart-dotted lazyload"
                                                data-bgset="<?php echo UI_ASSETS ?>images/products/dot-02.jpg"></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-05.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/megamenu/pr-06.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Blush Beanie</a>
                                    </h3>
                                    ...
                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-05.jpg"
                                            class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                class="tt_txt">Grey</span><span
                                                class="swatch__value bg_color_grey"></span></span>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh">
                                    <span class="tc nt_labels pa pe_none cw"><span
                                            class="onsale nt_label"><span>-25%</span></span></span>
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-classic/pr-11.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-classic/pr-10.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Cluse La Boheme Rose
                                            Gold</a>
                                    </h3>
                                    <span class="price dib mb__5"><del>$60.00</del><ins>$45.00</ins></span>
                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/home-classic/pr-10.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                class="tt_txt">Green</span><span
                                                class="swatch__value bg_color_green"></span></span>
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/home-classic/pr-09.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                class="tt_txt">Grey</span><span
                                                class="swatch__value bg_color_grey"></span></span>
                                        <span data-bgset="<?php echo UI_ASSETS ?>images/home-classic/pr-12.jpg"
                                            class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right"><span
                                                class="tt_txt">Blue</span><span
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    ...
                                    <a class="db" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-fashion-simple/pr-01.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_66"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-fashion-simple/pr-02.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right">
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Short Sleeved Hoodie</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    ...
                                    <a class="db" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/shop/pr-01.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/shop/pr-02.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right">
                                            <span class="tt_txt">Add to Wishlist</span><i class="facl facl-heart-o"></i>
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Chill candle</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    <a class="d-block" href="<?php echo base_url('product-detail/1')?>">
                                        <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-fashion-9/pr-s-47.jpg"></div>
                                    </a>
                                    <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                                        <div class="pr_lazy_img back-img pa nt_bg_lz lazyload padding-top__127_571"
                                            data-bgset="<?php echo UI_ASSETS ?>images/home-fashion-9/pr-s-48.jpg"></div>
                                    </div>
                                    <div class="nt_add_w ts__03 pa ">
                                        <a href="#" class="wishlistadd cb chp ttip_nt tooltip_right"><span
                                                class="tt_txt">Add to Wishlist</span><i
                                ...
                                <div class="product-info mt__15">
                                    <h3 class="product-title pr fs__14 mg__0 fwm">
                                        <a class="cd chp" href="<?php echo base_url('product-detail/1')?>">Sport Sneaker</a>
                                    </h3>
                                    <span class="price dib mb__5">$35.00</span>
                                </div>
                            </div>
