                                                        ...
                                                        <li class="cat-item">
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                <?php echo ucwords(getCateforyNameByID($key1)); ?><span
                                                                    class="cat_count d-inline-block">(<?php echo $val1['parent_cat_count']; ?>)</span>
                                                            </a>
                                                            <ul class="py-2 product_subcategory">
                                                                <?php if(!empty($sub_cat_list)){
                                                                    foreach($sub_cat_list as $subkey1=>$subval1){                                                                                                                                
                                                                ?>
                                                                <li>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="subcategory_filter(<?php echo  $subkey1; ?>)"
                                                                        id="filter_category_<?php echo  $key1 ?>">
                                                ...
                                                <div class="sp-tab-content">
                                                    <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
                                                        ...
                                                        foreach($color_list as $key=>$val){ ?>
                                                            <a href="javascript:void(0)"
                                                                onclick="color_filter(<?php echo $key; ?>)">
                                                                <span
                                                                    class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right">
                                                                    <span class="tt_txt"><?php echo $val['name'];?></span>
                                                                    <span class="swatch__value"
                                                                        style="background-color :<?php echo $val['code'];?>"></span>
                                                                </span>
                                                            </a>
                                                        <?php } }?>
                                                    </div>
                ...
                <div class="kalles-section tp_se_cdt">
                    <div class="filter-div">
                        <div class="result_clear">
                            <div class="sp_result_html  cb clear_filter result_count dn"><span class="cp"></span>
                                Products
                                Found</div>
                            <a class="clear_filter clear-all-filter dn" href="javascript:void(0)">Clear All</a>
                        </div>
                    ...
                    <div class="on_list_view_false products nt_products_holder row  row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default product_grid_list"
                        id="productList">
                    </div>
