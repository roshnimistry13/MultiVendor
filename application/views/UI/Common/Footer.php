			                        ...
			                        <div class="widget widget_text widget_logo">
			                            ...
			                            <div class="widget_footer">
			                                <div class="footer-contact">
			                                    ...
			                                    <p>
			                                        <i class="pegk pe-7s-map-marker">
			                                        </i>
			                                        <span>
			                                            206-A, Platinum Commercial
			                                            <br>
			                                            <span class="pl__30">
			                                                Center, Via Char Rasta Rd, opp.
			                                            </span>
			                                            <span class="pl__30">
			                                                VIA Ground, GIDC, Vapi,
			                                            </span>
			                                            <span class="pl__30">
			                                                Gujarat 396195
			                                            </span>
			                                    ...
			                                    <p>
			                                        ...
			                                        <span>
			                                            <a
			                                                href="https://themes.the4.co/cdn-cgi/l/email-protection#60030f0e1401031420030f0d10010e194e030f0d">
			                    ...
			                    <div class="col-lg-3 col-md-6 col-12 mb__50 order-lg-5 order-1">
			                        <div class="widget widget_text">
			                            ...
			                            <div class="widget_footer newl_des_1">
			                                ...
			                                <form id="subscribe_form" method="post"  action="<?php echo base_url('subscribe-newsletter'); ?>" class="mc4wp-form pr z_100">
			                                    <div class="mc4wp-form-fields">
			                                        <div class="signup-newsletter-form row no-gutters pr oh ">
			                                            <div class="col col_email">
			                                                <input type="email" name="email" placeholder="Your email address"
			                                                    value="" class="tc tl_md input-text" required="required">
			                                            </div>
			                                            <div class="col-auto">
			                                                <button type="submit"
			                    ...
			                    <div class="product-images-slider tc equal_nt nt_slider nt_carousel_qv p-thumb_qv nt_contain ratio_imgtrue position_8"
			                        ...
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            ...
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-01.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-02.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-03.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-04.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-05.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-06.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-07.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-08.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-09.jpg">
			                            </span>
			                        </div>
			                        <div data-grname="not4" data-grpvl="ntt4" class="js-sl-item q-item sp-pr-gallery__img w__100"
			                            data-mdtype="image">
			                            <span class="nt_bg_lz lazyload"
			                                data-bgset="<?php echo UI_ASSETS ?>images/quick_view/pr-10.jpg">
			                            </span>
			                        </div>
			                    </div>
			                </div>
			                    ...
			                    <div class="gecko-scroll-content-quick">
			                        <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
			                            ...
			                            <div class="flex wrap fl_between al_center price-review">
			                                ...
			                                <a href="<?php echo base_url('product-detail/1')?>" class="rating_sp_kl dib">
			                                    <div class="kalles-rating-result">
			                                        <span class="kalles-rating-result__pipe">
			                                            <span class="kalles-rating-result__start">
			                                            </span>
			                                            <span class="kalles-rating-result__start">
			                                            </span>
			                                            <span class="kalles-rating-result__start">
			                                            </span>
			                                            <span class="kalles-rating-result__start active">
			                                            </span>
			                                            <span class="kalles-rating-result__start">
			                                            </span>
			                                        </span>
			                                        <span class="kalles-rating-result__number">
			                                            (12 reviews)
			                                        </span>
			                                    </div>
			                                </a>
			                                            ...
			                                            <div class="swatch is-color kalles_swatch_js">
			                                                ...
			                                                <ul class="swatches-select swatch__list_pr">
			                                                    <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item is-selected"
			                                                        ...
			                                                        <span class="swatch__value_pr pr bg_color_pink">
			                                                        </span>
			                                                    </li>
			                                                    <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item"
			                                                        ...
			                                                        <span class="swatch__value_pr pr bg_color_black">
			                                                        </span>
			                                                    </li>
			                                                </ul>
			                                            </div>
			                                                ...
			                                                <div class="quantity pr mr__10 order-1 qty__true" id="sp_qty_qv">
			                                                    ...
			                                                    <div class="qty tc fs__14">
			                                                        <button type="button"
			                                                            ...
			                                                            <i class="facl facl-plus">
			                                                            </i>
			                                                        </button>
			                                                        <button type="button"
			                                                            class="minus db cb pa pd__0 pl__15 tl l__0">
			                                                            <i class="facl facl-minus">
			                                                            </i>
			                                                        </button>
			                                                    </div>
			                                                </div>
			                            ...
			                            <div id="trust_seal_qv" class="pr_trust_seal tl">
			                                <p class="mess_cd cb mb__10 fwm tu fs_16">
			                                </p>
			                                <img class="lazyload img_tr_s1 w__100"
			                                    ...
			                                    data-src="<?php echo UI_ASSETS ?>images/trust_img2.png" alt="">
			                            </div>
			                            <div class="product_meta">
			                                ...
			                                <span class="posted_in">
			                                    ...
			                                    <a href="javascript:void(0)" class="cg" title="Accessories">
			                                        Accessories
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="All">
			                                        All
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Best seller">
			                                        Best seller
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="New Arrival">
			                                        New
			                                        Arrival
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Sale">
			                                        Sale
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Watches">
			                                        Watches
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Women">
			                                        Women
			                                    </a>
			                                </span>
			                                <span class="tagged_as">
			                                    ...
			                                    <a href="javascript:void(0)" class="cg" title="Color Black">
			                                        Color
			                                        Black
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Color Pink">
			                                        Color Pink
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Price $7-$50">
			                                        Price $7-$50
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Vendor Kalles">
			                                        Vendor
			                                        Kalles
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="Watch">
			                                        Watch
			                                    </a>,
			                                    <a href="javascript:void(0)" class="cg" title="women">
			                                        women
			                            ...
			                            <a href="<?php echo base_url('cart')?>" class="btn fwsb detail_link p-0 fs__14">
			                                View
			                                full details
			                                <i class="facl facl-right">
			                                </i>
			                            </a>
			                        </div>
			                    </div>
			...
			<div id="quick-shop-tpl" class="dn">
			    <div class="wrap_qs_pr buy_qs_false kalles-quick-shop">
			                ...
			                <div class="pr oh qs_imgs_wrap">
			                    <div class="row equal_nt qs_imgs nt_slider nt_carousel_qs p-thumb_qs"
			                        ...
			                        <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz"
			                            data-bgset="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_01.jpg">
			                        </div>
			                        <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz"
			                            data-bgset="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_02.jpg">
			                        </div>
			                        <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz"
			                            data-bgset="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_03.jpg">
			                        </div>
			                        <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz"
			                            data-bgset="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_04.jpg">
			                        </div>
			                        <div class="col-12 js-sl-item qs_img_i nt_img_ratio lazyload nt_bg_lz"
			                            data-bgset="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_05.jpg">
			                        </div>
			                    </div>
			                </div>
			            </div>
			        ...
			        <div class="qs_info_i tc">
			                            ...
			                            <div class="nt_select_qs0 swatch is-color kalles_swatch_js">
			                                ...
			                                <ul class="swatches-select swatch__list_pr">
			                                    <li class="ttip_nt tooltip_top_right nt-swatch swatch_pr_item bg_css_green is-selected"
			                                        ...
			                                        <span class="swatch__value_pr pr bg_color_green">
			                                        </span>
			                                    </li>
			                                    <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item " data-escape="Grey">
			                                        ...
			                                        <span class="swatch__value_pr pr bg_color_grey">
			                                        </span>
			                                    </li>
			                                    <li class="ttip_nt tooltip_top nt-swatch swatch_pr_item bg_css_blue "
			                                        ...
			                                        <span class="swatch__value_pr pr bg_color_blue">
			                                        </span>
			                                    </li>
			                                </ul>
			                            </div>
			            ...
			            <a href="<?php echo base_url('cart')?>" class="btn fwsb detail_link dib mt__15">
			                View full details
			                <i class="facl facl-right">
			                </i>
			            </a>
			...
			<div id="nt_cart_canvas" class="nt_fk_canvas dn">
			    <div class="nt_mini_cart nt_js_cart flex column h__100 btns_cart_1">
			        ...
			        <div class="mini_cart_wrap">
			                ...
			                <div class="fixcl-scroll-content">
			                    <div class="empty tc mt__40 dn">
			                        ...
			                        <p class="return-to-shop mb__15">
			                            <a class="button button_primary tu js_add_ld" href="javascript:void(0)">
			                                Return To
			                                Shop
			                            </a>
			                        </p>
			                    ...
			                    <div class="mini_cart_items js_cat_items lazyload">
			                        <div class="mini_cart_item js_cart_item flex al_center pr oh">
			                            ...
			                            <a href="<?php echo base_url('product-detail/1')?>" class="mini_cart_img">
			                                <img class="w__100 lazyload"
			                                    data-src="<?php echo UI_ASSETS ?>images/quick_shop/p_qs_01.jpg" width="120"
			                                    height="153" alt=""
			            ...
			            <div class="mini_cart_footer js_cart_footer">
			                ...
			                <div class="cat_img_trust mt__10 lazyload">
			                    <img class="w__100 lz_op_ef" src="<?php echo UI_ASSETS ?>images/trust_img2.png" width="360"
			                        height="46" alt="">
			                </div>
			            </div>
			        </div>
			        ...
			        <div class="mini_cart_note pe_none">
			            ...
			            <textarea name="note" id="CartSpecialInstructions" placeholder="How can we help you?">
					</textarea>
			        ...
			        <div class="mini_cart_gift pe_none">
			            <div class="shipping_calculator tc">
			                ...
			                <p class="field">
			                    <a href="javascript:void(0)" class="w__100 tu tc button button_primary truncate js_addtc">
			                        Add A Gift Wrap
			                    </a>
			                </p>
			                <p class="field">
			        ...
			        <div class="mini_cart_ship pe_none">
			            <div class="shipping_calculator">
			                ...
			                <p class="field">
			                    <label for="address_country_ship">
			                        Country
			                    </label>
			    ...
			    <div class="nt_mini_cart flex column h__100">
			        ...
			        <div class="mini_cart_wrap">
			            <div class="search_header mini_search_frm pr js_frm_search" role="search">
			                ...
			                <div class="ld_bar_search">
			                </div>
			            </div>
			            <div class="search_header__prs fwsb cd">
			                <span class="h_suggest">
			                    Need some inspiration?
			                </span>
			                <span class="h_result dn">
			                    Search
			                    Result:
			                </span>
			                <span class="h_results dn">
			                    Search Results:
			                </span>
			            </div>
			                    ...
			                    <div class="js_prs_search">
			                        <div class="row mb__10 pb__10">
			                            <div class="col widget_img_pr">
			                                <a class="db pr oh" href="<?php echo base_url('product-detail/1')?>">
			                                    <img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201200%201200%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
			                                        class="w__100 lz_op_ef lazyload" alt="sunlight bell solar lamp"
			                                        data-src="<?php echo UI_ASSETS ?>images/shopping-cart/thumb-01.jpg" width="80"
			                                        height="80">
			                                </a>
			                            </div>
			                            <div class="col widget_if_pr">
			                                <a class="product-title db" href="<?php echo base_url('product-detail/1')?>">
			                                    sunlight bell solar
			                                    lamp
			                                </a>$35.00
			                            </div>
			                        ...
			                        <div class="row mb__10 pb__10">
			                            <div class="col widget_img_pr">
			                                <a class="db pr oh" href="<?php echo base_url('product-detail/1')?>">
			                                    <img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
			                                        class="w__100 lz_op_ef lazyload" alt="cru thermos jug"
			                                        data-src="<?php echo UI_ASSETS ?>images/shopping-cart/thumb-01.jpg" width="80"
			                                        height="80">
			                                </a>
			                            </div>
			                        ...
			                        <div class="row mb__10 pb__10">
			                            <div class="col widget_img_pr">
			                                <a class="db pr oh" href="<?php echo base_url('product-detail/1')?>">
			                                    <img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
			                                        class="w__100 lz_op_ef lazyload" alt="brush set small"
			                                        data-src="<?php echo UI_ASSETS ?>images/shopping-cart/thumb-01.jpg" width="80"
			                                        height="80">
			                                </a>
			                            </div>
			                        ...
			                        <div class="row mb__10 pb__10">
			                            <div class="col widget_img_pr">
			                                <a class="db pr oh" href="<?php echo base_url('product-detail/1')?>">
			                                    <img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
			                                        class="w__100 lz_op_ef lazyload" alt="stripe oilcloth"
			                                        data-src="<?php echo UI_ASSETS ?>images/shopping-cart/thumb-01.jpg" width="80"
			                                        height="80">
			                                </a>
			                            </div>
			                        ...
			                        <div class="row mb__10 pb__10">
			                            <div class="col widget_img_pr">
			                                <a class="db pr oh" href="<?php echo base_url('product-detail/1')?>">
			                                    <img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E"
			                                        class="w__100 lz_op_ef lazyload" alt="picto wall clock"
			                                        data-src="<?php echo UI_ASSETS ?>images/shopping-cart/thumb-01.jpg" width="80"
			                                        height="80">
			                                </a>
			                            </div>
			                        ...
			                        <a href="#" class="btn fwsb detail_link">
			                            View All
			                            <i class="las la-arrow-right fs__18">
			                            </i>
			                        </a>
			                    </div>
			                </div>
			...
			<div id="nt_login_canvas" class="nt_fk_canvas dn lazyload">
				<?php if(empty($this->session->userdata[CUSTOMER_SESSION])){?>
					<form method="post" action="<?php echo base_url('customer-login')?>" id="customer-login" class="nt_mini_cart flex column h__100 is_selected">
						<div class="mini_cart_header flex fl_between al_center">
						...
						<div class="mini_cart_wrap">
							<div class="mini_cart_content fixcl-scroll">
								<div class="fixcl-scroll-content">
									<p class="form-row">
										<label for="txt_cust_email_phone">
											Email ID/ Mobile No
											<span class="required">
												*
											</span>
										</label>
										<input type="text" name="txt_cust_email_phone" id="txt_cust_email_phone" autocomplete="email"
											autocapitalize="off" required>
									</p>
									<p class="form-row">
										<label for="txt_cust_password">
											Password
											<span class="required">
												*
											</span>
										</label>
										<input type="password" value="" name="txt_cust_password" autocomplete="current-password"
											id="txt_cust_password" required>
					...
					<form id="RecoverForm" method="post" action="#" class="nt_mini_cart flex column h__100">
						<div class="mini_cart_header flex fl_between al_center">
							<div class="h3 widget-title tu fs__16 mg__0">
								Recover password
							</div>
							...
							<div class="mini_cart_content fixcl-scroll">
								<div class="fixcl-scroll-content">
									<p class="form-row">
										...
										<input type="email" name="recoverEmail" id="recoverEmail" class="input-full"
									...
									<p class="mb__10 mt__20">
										...
										<a href="#" data-id="#customer-login" class="link_acc">
											Back to login
										</a>
									</p>
								</div>
					...
					<form id="RegisterForm" method="post" action="<?php echo base_url('register-customer')?>" class="nt_mini_cart flex column h__100">
						<div class="mini_cart_header flex fl_between al_center">
							<div class="h3 widget-title tu fs__16 mg__0">
								Register
							</div>
							...
							<div class="mini_cart_content fixcl-scroll">
								<div class="fixcl-scroll-content">
									<p class="form-row">
										...
										<input type="text" class="form-control form-control-sm" name="name" id="name" autocomplete="given-name">
									</p>			                    
									<p class="form-row">
										<label for="email">
											Email
										...
										<input type="email" class="form-control form-control-sm" name="email" id="email" class="" autocapitalize="off"
									...
									<p class="form-row">
										...
										<input type="text" class="form-control form-control-sm" name="contact_no" id="contact_no" autocomplete="family-name">
									</p>
									<p class="form-row">
										<label for="password">
											Password
									...
									<p class="form-row mb-0">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_male" value="male">
											<label class="form-check-label" for="txt_male">Male</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_female" value="female">
											<label class="form-check-label" for="txt_female">Female</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_other" value="other">
											<label class="form-check-label" for="txt_other">Other</label>
										</div>
									</p>
				...
				<?php }else{ 					
					$cust_session 		= $this->session->userdata[CUSTOMER_SESSION];
					$customer_id 		= $cust_session['customer_id'];
					$name 				= $cust_session['customer_name'];
					$email 				= $cust_session['email'];
					$phone 				= $cust_session['mobile'];
					$gender 			= $cust_session['gender'];
				?>
					<form id="RegisterForm" method="post" action="<?php echo base_url('register-customer')?>" class="nt_mini_cart flex column h__100 is_selected">
						<div class="mini_cart_header flex fl_between al_center">
							<div class="h3 widget-title tu fs__16 mg__0">
								Profile
							</div>
							...
							<div class="mini_cart_content fixcl-scroll">
								<div class="fixcl-scroll-content">
									<p class="form-row">
										...
										<input type="text" class="form-control form-control-sm" name="name" id="name" autocomplete="given-name" value="<?php echo $name;?>">
									</p>			                    
									<p class="form-row">
										<label for="email">
											Email
										...
										<input type="email" class="form-control form-control-sm" name="email" id="email" class="" autocapitalize="off"
											autocomplete="email" aria-required="true" value="<?php echo $email;?>">
									</p>
									<p class="form-row">
										<label for="contact_no">
											Contact No
										...
										<input type="text" class="form-control form-control-sm" name="contact_no" id="contact_no" autocomplete="family-name" value="<?php echo $phone;?>">
									</p>									
									<p class="form-row mb-0">
										<label for="password">
											Gender
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_male" value="male" <?php echo ($gender == "male") ? 'checked' : '' ?>>
											<label class="form-check-label" for="txt_male">Male</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_female" value="female" <?php echo ($gender == "female") ? 'checked' : '' ?>>
											<label class="form-check-label" for="txt_female">Female</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="gender" id="txt_other" value="other" <?php echo ($gender == "other") ? 'checked' : '' ?>>
											<label class="form-check-label" for="txt_other">Other</label>
										</div>
									</p>
									<input type="submit" value="Save" class="button button_primary w__100 tu js_add_ld">
									<br>
									<p class="mb__10 mt__20">
										Change Password ?
										<a href="#" data-id="#change-password" class="link_acc">
											Click here
										</a>
									</p>
								</div>
					...
					<form id="change-password" method="post" action="<?php echo base_url('change-password')?>" class="nt_mini_cart flex column h__100">
						<div class="mini_cart_header flex fl_between al_center">
							<div class="h3 widget-title tu fs__16 mg__0">
								Change Password
							</div>
							...
							<div class="mini_cart_content fixcl-scroll">
								<div class="fixcl-scroll-content">									
									<p class="form-row">
										...
										<input type="password" class="form-control form-control-sm" name="current_password" id="current_password" autocomplete="family-name">
									</p>									
									<p class="form-row">
										...
										<input type="password" class="form-control form-control-sm" name="new_password" id="new_password" autocomplete="family-name">
									</p>									
									<p class="form-row">
										...
										<input type="password" class="form-control form-control-sm" name="confrim_password" id="confrim_password" autocomplete="family-name">
									</p>									
									<input type="submit" value="Change" class="button button_primary w__100 tu js_add_ld">
									<br>
									<p class="mb__10 mt__20">
			...
			<div id="kalles-section-toolbar_mobile" class="kalles-section">
			    <div class="kalles_toolbar kalles_toolbar_label_true ntpf r__0 l__0 b__0 flex fl_between al_center">
			        ...
			        <div class="type_toolbar_wish kalles_toolbar_item">
			            <a class="js_link_wis" href="javascript:void(0)">
			                <span class="toolbar_icon">
			                    <span class="jswcount toolbar_count">
			                        3
			                    </span>
			                </span>
			                <span class="kalles_toolbar_label">
			            ...
			            <ul id="menu_mb_ul" class="nt_mb_menu">
			                    ...
			                    <ul class="sub-menu">
			                        <li class="menu-item menu-item-has-children only_icon_false">
			                            ...
			                            <ul class="sub-sub-menu">
			                                ...
			                                <li class="menu-item">
			                                    <a href="home-instagram-javascript:void(0)">
			                                        Home Instagram Shop
			                                    </a>
			                                </li>
			                                <li class="menu-item">
			                    ...
			                    <ul class="sub-menu">
			                        ...
			                        <li class="menu-item">
			                            <a href="product-detail-grouped-product.html">
			                                Grouped Product
			                                <span class="lbc_nav_mb ml__5 lb_menu_hot">
			                                    hot
			                                </span>
			                            </a>
			                        </li>
			                        ...
			                        <li class="menu-item">
			                            <a href="product-detail-description-with-instagram-javascript:void(0)">
			                                Description with instagram
			                                shop
			                            </a>
			                        </li>
			                        <li class="menu-item">
			                ...
			                <li class="menu-item menu-item-has-children only_icon_false">
			                    ...
			                    <ul class="sub-menu">
			                        ...
			                        <li class="menu-item">
			                            <a href="single-portfolio-with-javascript:void(0)">
			                        ...
			                        <li class="menu-item">
			                            <a href="single-portfolio-with-instagram-javascript:void(0)">
			                ...
			                <li class="menu-item menu-item-has-children only_icon_false">
			                    ...
			                    <ul class="sub-menu">
			                        ...
			                        <li class="menu-item">
			                            <a href="blog-post-with-lookbook.html">
			                ...
			                <li class="menu-item menu-item-infos">
			                    ...
			                    <div class="menu_infos_text">
			                        <i class="pegk pe-7s-call fwb mr__10">
			                        </i>+01 23456789<br>
			                        <i class="pegk pe-7s-mail fwb mr__10">
			                        </i>
			                        <a class="cg"
			                            href="https://themes.the4.co/cdn-cgi/l/email-protection#64070805110124000b09050d0a4a070b09">
			                            <span class="__cf_email__" data-cfemail="7e1d121f0b1b3e1a11131f1710501d1113">
			                                [email&#160;protected]
			                            </span>
			                        </a>
			                    </div>
			                ...
			                <li class="menu-item menu-item-has-children only_icon_false currencies">
			                    <a href="#">
			                        <span class="current dib flagst4 flagst4-sm flagst4-USD lazyload">
			                            USD
			                        </span>
			                        <span class="nav_link_icon ml__5">
			                        </span>
			                    ...
			                    <ul class="sub-menu">
			                        <li>
			                            <a class="currency-item nt-currency-flag--aud--w16-h-12 cg db" href="#">
			                                AUD
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--cad--w16-h-12 cg db" href="#">
			                                CAD
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--dkk--w16-h-12 cg db" href="#">
			                                DKK
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--eur--w16-h-12 cg db" href="#">
			                                EUR
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--gbp--w16-h-12 cg db" href="#">
			                                GBP
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--hkd--w16-h-12 cg db" href="#">
			                                HKD
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--jpy--w16-h-12 cg db" href="#">
			                                JPY
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--nzd--w16-h-12 cg db" href="#">
			                                NZD
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--sgd--w16-h-12 cg db" href="#">
			                                SGD
			                            </a>
			                        </li>
			                        <li>
			                            <a class="currency-item nt-currency-flag--usd--w16-h-12 cg db selected" href="#">
			                                USD
			                            </a>
			                        </li>
			                    </ul>
			    ...
			    <div id="kalles-section-mb_cat_js" class="mb_nav_tab">
			        <div id="kalles-section-mb_cat" class="kalles-section">
			            <ul id="menu_mb_cat" class="nt_mb_menu">
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-female mr__10 fs__20">
			                        </i>Women’s
			                        Clothing
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-male mr__10 fs__20">
			                        </i>Men’s Clothing
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-clock mr__10 fs__20">
			                        </i>Watches
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-glasses mr__10 fs__20">
			                        </i>Accessories
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-camera-retro mr__10 fs__20">
			                        </i>Electric
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-shoe-prints mr__10 fs__20">
			                        </i>Shoes
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-gem mr__10 fs__20">
			                        </i>Jewellery
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-tshirt mr__10 fs__20">
			                        </i>T-Shirt
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-child mr__10 fs__20">
			                        </i>Toys, Kids &amp;
			                        Baby
			                    </a>
			                </li>
			                <li class="menu-item">
			                    <a href="javascript:void(0)">
			                        <i class="las la-chair mr__10 fs__20">
			                        </i>Decor
			                    </a>
			                </li>
			            </ul>
			...
			<a id="nt_backtop" class="pf br__50 z__100 des_bt1" href="#">
			    <span class="tc br__50 db cw">
			        <i class="pr pegk pe-7s-angle-up">
			        </i>
			    </span>
			</a>
			        ...
			        <div class="wrap_title">
			            <h3 class="section-title tc pr flex fl_center al_center fs__24 title_2">
			                <span class="mr__10 ml__10">
			                    Wait! Can't find what you're looking for?
			                </span>
			            </h3>
			                    ...
			                    <div class="product-info mt__15">
			                        ...
			                        <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-05.jpg"
			                                ...
			                                <span class="swatch__value bg_color_grey">
			                                </span>
			                            </span>
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-30.jpg"
			                                class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right">
			                                <span class="tt_txt">
			                                    Pink
			                                </span>
			                                <span class="swatch__value bg_color_pink">
			                                </span>
			                            </span>
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-30.jpg"
			                                class="lazyload nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right">
			                                ...
			                                <span class="swatch__value bg_color_black">
			                                </span>
			                            </span>
			                        </div>
			                    </div>
			                    ...
			                    <div class="product-info mt__15">
			                        ...
			                        <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-07.jpg"
			                                ...
			                                <span class="swatch__value bg_color_green">
			                                </span>
			                            </span>
			                            ...
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-06.jpg"
			                                ...
			                                <span class="swatch__value bg_color_blue">
			                                </span>
			                            </span>
			                        </div>
			                    </div>
			                    ...
			                    <div class="product-info mt__15">
			                        ...
			                        <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
			                            ...
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-14.jpg"
			                                ...
			                                <span class="swatch__value bg_color_heart-dotted lazyload"
			                    ...
			                    <div class="product-info mt__15">
			                        ...
			                        <div class="swatch__list_js swatch__list lh__1 nt_swatches_on_grid">
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-27.jpg"
			                                ...
			                                <span class="swatch__value bg_color_pink lazyload">
			                                </span>
			                            </span>
			                            <span data-bgset="<?php echo UI_ASSETS ?>images/products/pr-27.jpg"
			                                class="nt_swatch_on_bg swatch__list--item pr ttip_nt tooltip_top_right">
			...
			<script src="<?php echo UI_ASSETS ?>js/jarallax.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/packery.pkgd.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/jquery.hoverIntent.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/magnific-popup.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/flickity.pkgd.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/lazysizes.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/js-cookie.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/jquery.countdown.min.js"></script>
			<script src="<?php echo UI_ASSETS ?>js/photoswipe.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/photoswipe-ui-default.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/drift.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/isotope.pkgd.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/resize-sensor.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/theia-sticky-sidebar.min.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/interface.js" ></script>
			<script src="<?php echo UI_ASSETS ?>js/cdn-cgi/rocket-loader.min.js" data-cf-settings="ef9bdb9ec00fa880b5b2f56c-|49" defer=""></script>
