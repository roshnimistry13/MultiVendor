                ...
                <div class="cart_item js_cart_item">
                    ...
                    <div class="row al_center">
                            ...
                            <div class="page_cart_info flex al_center">
                                ...
                                <div class="mini_cart_body ml__15">
                                    ...
                                    <div class="mini_cart_meta">
                                        <p class="cart_selling_plan mb-1">Quantity : <?php echo $quantity;?></p>
                                        <p class="cart_selling_plan mb-1">Seller : <?php echo $vendor_name;?></p>
                        ...
                        <div class="col-12 col-md-3 col-lg-3 tc mini_cart_actions">                            
                            ...
                            ?>
                                <button type="button" class="single_add_to_cart_button button truncate js_frm_cart mb-2 btn-return-replace" data-btnname="<?php echo $row1;?>" data-orderid="<?php echo $order_id;?>" data-productid="<?php echo $product_id;?>">
			                ...
			                <form method="post" action=""
								...
								<div class="form-row mb-3">
									...
									<div class="col-12">
			                            ...
			                            <input type="text" class="form-control form-control-sm valid" name="txtcoment" id="txtcoment"
			                                value="">
									</div>
								</div>
                                <div id="refund_div" class="form-row mb-3">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm valid" name="txt_acc_no" id="txt_acc_no">                                
                                    </div>                                   
                                    <div class="col-12 col-lg-6">
                                        <label for="fname">
			                               Account Holder Name		                                
			                            </label>    
                                        <input type="text" class="form-control form-control-sm valid" name="txt_account_name" id="txt_account_name">                                
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="fname">
			                               Phone No		                                
			                            </label>    
                                        <input type="text" class="form-control form-control-sm valid" name="txt_phone_no" id="txt_phone_no">                                
                                    </div>
                                </div>
								<div class="form-row mb-3">
                                    <div class="col-12">
