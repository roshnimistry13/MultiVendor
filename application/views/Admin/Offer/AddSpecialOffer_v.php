<?php
	...
	if(!empty($result))
	{
		...
		$ordered_amount     = $result[0]['ordered_amount'];	
                                ...
                                <div class="card-body py-md-30">
                                    <div class="horizontal-form">
                                        <form method="post" class="form-horizontal"
                                            action="<?php echo base_url().'submit-special-offer' ?>"
                                            id="special-offer-form" name="special-offer-form"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control ih-small form-control-default"
                                                            id="txt_offer_title" name="txt_offer_title"
                                                            placeholder="i.e.,10% off on orders of ₹5,000 and above"
                                                ...
                                                <div class="col-12 col-md-6 col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            name="text_offer_amt" placeholder="Offer Amount" min="0"
                                                ...
                                                <div class="col-12 col-md-6 col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control ih-small form-control-default"
                                                            id="txt_order_value" name="txt_order_value"
                                                            placeholder="Purchase Amount" required value="<?php echo $ordered_amount;?>">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="text_offer_category" name="text_offer_category[]"
                                                            ...
                                                            <option value="<?php echo $row['category_id']; ?>"
                                                                <?php echo $selected;?>>
                                                                <?php echo $row['category_name'].' ('. $fullhierarchy .')'; ?>
                                                            </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="checkbox-theme-default custom-checkbox ">
                                                            <input class="checkbox" type="checkbox"
                                                                name="text_is_active" value="1" id="text_is_active"
                                                                <?php echo $is_active; ?>>
                                            ...
                                            <div class="form-group row mt-3">
                                                <div class="col-sm-12 d-flex aling-items-center">
                                                    ...
                                                    <a class="btn btn-light btn-xs px-30 ml-2"
                                                        href="<?php echo base_url('special-offer')?>">
                                                        Cancel
                                                    </a>
                                                </div>
