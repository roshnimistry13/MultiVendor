                            ...
                            <div class="horizontal-form">
                                <form method="post" class="form-horizontal"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-10 div-subcategory">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="text_subcategory_id" name="text_subcategory_id"
                                                ...
                                                <div class="col-md-8 mb-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="product_tag" name="product_tag"
                                                            value="<?php echo $tag;?>" data-role="tagsinput" id="tags"
                                                            class="form-control product_tag">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card card-horizontal card-default card-md mb-4 border">
                                        ...
                                        <div class="card-body border-top">
                                            <div class="row">
                                                <div class="col-md-3 mb-10 qty-ele-attr d-none">
                                                    <div class="form-group">
                                                        <label for="formGroupExampleInput"
                                                            class="color-dark fs-14 fw-500 align-center">
                                                            QTY
                                                ...
                                                <div class="col-md-3 mb-10">
                                                    <label for="text_tax" class="color-dark fs-14 fw-500 align-center">
                                                       &nbsp; 
                                                    </label>
                                                    <div class="radio-horizontal-list d-flex">
                                                        <div class="radio-theme-default custom-radio ">
                                                            <input class="radio" type="radio" name="gst-type"
                                                                value="inclusive" id="radio-gst-include" <?php echo ($gst_type == "inclusive") ? "checked" : ''?>>
                                                            <label for="radio-gst-include">
                                                                <span class="radio-text">Inclusive</span>
                                                            </label>
                                                        </div>
                                                        <div class="radio-theme-default custom-radio ">
                                                            <input class="radio" type="radio" name="gst-type"
                                                                value="exclusive" id="radio-gst-exclude" <?php echo ($gst_type == "exclusive") ? "checked" : ''?>>
                                                            <label for="radio-gst-exclude">
                                                                <span class="radio-text">Exclusive</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select id="text_tax" name="text_tax"
                                                            ...
                                                            <?php
                                                                    ...
                                                                    if(!empty($gst_array)){
                                                                        ...
                                                                        { ?>
                                                            <option <?php echo ($key == $tax) ? 'selected' : ''; ?>
                                                                value="<?php echo $key ?>">
                                                                <?php echo $val ?>
                                                            </option>
                                                            <?php }
                                                                ...
                                                                <div class="atbd-collapse-item">
                                                                    <div class="atbd-collapse-item__header">
                                                                        <a href="#" class="item-link collapsed"
                                                                            ...
                                                                            <h6 class="color-primary" class="fw-600">
                                                                                Meta Data</h6>
                                                                        </a>
                                                                    </div>
